...
const zombieLeftHandImg = new Image(); zombieLeftHandImg.src = '/images/zombielefthand.png?v=2';
const zombieRightHandImg = new Image(); zombieRightHandImg.src = '/images/zombierighthand.png?v=2';
const zombieT2LeftHandImg = new Image(); zombieT2LeftHandImg.src = '/images/T2zombielefthand.png?v=2';
const zombieT2RightHandImg = new Image(); zombieT2RightHandImg.src = '/images/T2zombierighthand.png?v=2';
